// Program to convert an INfix expression to prefix from.
...
// initialize elements of structure variable
...
// converts the infix exper. to prefix form
...
// Returns the priority of the operator
    ...
    // displays the prefix form of the given expr.
