// Program to add a new node to the ascending order linkedlist
...
// adds node to an ascending order linkedList
...
void add (struct node **q, int num) {
    ...
    if (*q == NULL || (*q) -> data > num) {
        *q = r;
        ...
        // traverse the entire linkedList to search the position to insert the new node
        while (temp != NULL) {
